...
urlpatterns = [
    ...
    path('campaigns/<uuid:pk>/resume/', CampaignViewSet.as_view({'post': 'resume'}), name='campaign-resume'),
    path('campaigns/<uuid:pk>/cancel/', CampaignViewSet.as_view({'post': 'cancel'}), name='campaign-cancel'),
    path('campaigns/<uuid:pk>/stop/', CampaignViewSet.as_view({'post': 'cancel'}), name='campaign-stop'),
