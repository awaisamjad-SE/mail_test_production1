export const emailTemplates = [
  {
    ...
    icon: '💼',
    category: 'Job Seeker',
    description: 'Professional cold application seeking open roles at a target company.',
    subject: 'Interested in {{role}} role at {{company}} - {{Name}}',
    defaultHeadline: 'Hi {{Name}},',
    defaultBody: 'I hope this email finds you well.\n\nI am writing to express my strong interest in the {{role}} position at {{company}}. With my background in building scalable web applications and optimizing system performance, I am confident in my ability to bring immediate value to your engineering team.\n\nI have attached my resume link below for your convenience. I would welcome the opportunity to discuss how my skills and experience align with your team\'s goals.\n\nThank you for your time and consideration.',
    layoutType: 'interview',
    defaultButtonText: 'View My Resume',
    defaultButtonUrl: '{{resume_link}}',
    hasButton: true,
    defaultHeaderColor: '#2563eb',
    defaultBgColor: '#f4f6f9'
  },
  {
    id: 'referred_job_apply',
    name: 'Referral Connection Outreach',
    icon: '🤝',
    category: 'Job Seeker',
    description: 'Cold application referencing a mutual connection or warm introduction.',
    subject: 'Outreach regarding {{role}} role at {{company}} (via {{referrer}})',
    defaultHeadline: 'Hi {{Name}},',
    defaultBody: 'I hope you are having a productive week.\n\nOur mutual connection, {{referrer}}, suggested I reach out to you regarding the open {{role}} position at {{company}}. They spoke highly of your leadership and the innovative engineering culture you are building.\n\nBased on my expertise in JavaScript, React, and Python backend services, I believe my background aligns perfectly with your team\'s current technical needs.\n\nI have included a link to my portfolio and resume below. I would love to schedule a brief 10-minute call to introduce myself and learn more about the team.',
    layoutType: 'meeting',
    defaultButtonText: 'Choose Meeting Slot',
    defaultButtonUrl: 'https://calendly.com/yourname/chat',
    hasButton: true,
    defaultHeaderColor: '#16a34a',
    defaultBgColor: '#f4f6f9'
  },
  {
    id: 'job_follow_up',
    ...
    icon: '🔔',
    category: 'Job Seeker',
    description: 'Professional follow-up email to check status of a submitted job application.',
    subject: 'Following up on my application for {{role}} at {{company}} - {{Name}}',
    defaultHeadline: 'Hi {{Name}},',
    defaultBody: 'I hope you are doing well.\n\nI recently submitted my application for the {{role}} position at {{company}} via your portal, and I wanted to follow up to reiterate my enthusiasm for the role.\n\nGiven the team\'s focus on high deliverability and scale, I am very excited about the prospect of contributing to your upcoming milestones. Please let me know if there are any additional details or references I can provide to support my application.\n\nThank you for your time and guidance.',
    layoutType: 'standard',
    defaultButtonText: 'View Portfolio',
    defaultButtonUrl: 'https://yourportfolio.com',
    hasButton: true,
  ...
  },
  {
    ...
    name: 'Recruiter Cold Inquiry',
    icon: '🎯',
    category: 'Job Seeker',
    description: 'Direct inquiry to general recruiters to connect and request open vacancy reviews.',
    subject: 'Quick inquiry from a Software Engineer - {{Name}}',
    defaultHeadline: 'Hi {{Name}},',
    defaultBody: 'I hope your day is going well.\n\nI am a Software Engineer specializing in developing high-throughput web apps and cloud-native solutions. I have been following {{company}}\'s recent product expansions, and I am very impressed by your team\'s work.\n\nI wanted to reach out and ask if you have any upcoming openings for engineering talent. I have linked my professional resume below for your reference. I would love to connect and keep in touch for future opportunities.',
    layoutType: 'interview',
    defaultButtonText: 'Open Resume Profile',
    defaultButtonUrl: 'https://linkedin.com/in/yourprofile',
    hasButton: true,
    defaultHeaderColor: '#1e293b',
    defaultBgColor: '#f4f6f9'
  },
  {
    id: 'interview_update',
